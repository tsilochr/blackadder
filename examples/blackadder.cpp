...
void Blackadder::publish_scope(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(PUBLISH_SCOPE, id, prefix_id, strategy, LID);
}

void Blackadder::publish_info(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(PUBLISH_INFO, id, prefix_id, strategy, LID);
}

void Blackadder::unpublish_scope(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(UNPUBLISH_SCOPE, id, prefix_id, strategy, LID);
}

void Blackadder::unpublish_info(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(UNPUBLISH_INFO, id, prefix_id, strategy, LID);
}

void Blackadder::subscribe_scope(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(SUBSCRIBE_SCOPE, id, prefix_id, strategy, LID);
}

void Blackadder::subscribe_info(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(SUBSCRIBE_INFO, id, prefix_id, strategy, LID);
}

void Blackadder::unsubscribe_scope(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(UNSUBSCRIBE_SCOPE, id, prefix_id, strategy, LID);
}

void Blackadder::unsubscribe_info(string &id, string &prefix_id, char strategy, char *LID) {
    create_and_send_buffers(UNSUBSCRIBE_INFO, id, prefix_id, strategy, LID);
}
...
Event Blackadder::getEvent() {
    ...
    if (total_buf_size > 0) {
        ...
        return Event(type, str_id, data, data_len, buf);
    } else {
        return Event(0, "", NULL, 0, NULL);
    }
}
